    ...
    return (
        <div>
            ...
            <div>
                ...
                : <article className="grid place-items-center w-full max-w-2xl relative">
                <h1>{post.title}</h1>
                ...
                {/* Edit button  */}
                {isLoggedIn && <button className="btn-primary absolute top-0 right-0 flex gap-5" onClick={()=>history.push(`/admin/edit-post/${post._id}`)}>
