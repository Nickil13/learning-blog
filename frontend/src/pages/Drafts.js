        ...
        <div className="grid place-items-center w-full dark:bg-gray-600 py-10 rounded-md">
            ...
            <div className="p-10 w-full max-w-5xl">
                ...
                <div className="grid grid-flow-row">
                    ...
                    drafts.map((draft)=>{
                        return(
                            <AdminRow key={draft._id} document={draft} handleEditDocument={()=>history.push(`/admin/edit-draft/${draft._id}`)} handleDeleteDocument={handleDeleteDraft} documentPath='/admin/drafts'/>
                        );
                    })
                    }
