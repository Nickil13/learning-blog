...
export default function ImageInput({name, onUploadClick, handleUploadSelect, setSelectorShowing}) {
    ...
    return ( 
        <div className="p-5 grid gap-5 justify-center bg-purple-200 items-center">
            ...
            <div className="text-center">
                ...
                <div className="flex space-between">
                    ...
                    <button type="button" className="cursor-pointer hover:text-purple-500 dark:hover:text-white text-2xl" onClick={()=>setSelectorShowing(true)}><BsImage/></button>
                </div>
            </div>
            ...
            <div className="flex items-center justify-center">
                ...
                <button className="btn-primary w-20" onClick={handleUploadImage}>Upload {file && file.name}</button>
            </div>
