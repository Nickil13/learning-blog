    ...
    return (
        <div className="absolute flex flex-col items-center justify-self-center py-5">
            ...
            <div className=" grid justify-center bg-gray-200 rounded-full border-gray-200 w-9 h-16 dark:bg-gray-500">
                {/* Toggle button */}
                <div className={`bg-white w-7 h-7 my-1 rounded-full  cursor-pointer transform ${theme==='dark' && "transform translate-y-full"} transition duration-800 ease-linear dark:bg-purple-200`} onClick={toggleTheme}></div>
            </div>
